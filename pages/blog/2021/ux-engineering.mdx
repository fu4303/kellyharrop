...
Because UX Engineering is a relatively new role and the responsibilities can widely shift depending on the company, it can get pretty tricky to explain to folks what we actually do for a living.

Hopefully this article will get you interested in hiring one for your team, or start applying as one!

![Geometric shape patterns in a grid](/images/pattern.png)

## What's a UX Engineer?

Generally speaking, a UXE (UX Engineer) is someone who uses design thinking and principles to implement solutions with code.
...
Our design team includes representation from each of our business units, to make sure each product as voice within the system.
...
To help designers on our team understand which experience are disparate amongst our products, we needed to establish (and commit to) explicit attributes within our design specs:
...
Creating a template in Figma with corresponding visuals has been a great way to get buy-in for alignment.
...
UX Engineers typically work with designers to explain the impact of design decisions (or confirm this wasn't a mistake in the spec) so that situations like this don't happen.

It also means we sometimes need to act as negotiators in order to strengthen the logic within our system.

## Architecting scalable blueprints

Because UXE's are responsible for making sure a component accurately reflects design specifications, it's crucial that a component's coded blueprint supports the same logic, plus future considerations.
...
- Puts ego aside and listens to the community
- Collaborates well with designers, developers, and PM

I've found what's worked best is to include all disciplines in a JIRA board and include everyone to our sprint retro/planning sessions to ensure everyone is aware of what tasks need to be completed until we're ready to ship.
...
I'm excited to see more of these opportunities pop up, and super happy I was able to make the role what it is for our design system.
