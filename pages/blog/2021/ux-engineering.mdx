...
Generally speaking, a UXE (User Experience Engineer) is someone who uses design thinking and user behaviorial data to implement solutions with code.
...
Because UXE's are responsible for making sure a component accurately reflects design specifications, it's crucial that a component supports the same logic, plus future considerations.
